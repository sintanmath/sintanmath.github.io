...
export const scenes: SceneDefinition[] = [
  ...
  },
  {
    ...
    interaction: '拖动装配进度：从第一个球接出整根棍，再接上整颗球；每一步都是有或没有，不会渐变长出。',
  },
  {
    id: 'direction-node',
    number: '08',
    ...
    title: '把更多方向收进同一个球',
    shortTitle: '多方向节点',
    thesis: '同一个球上的 12、20、30 个孔，已经能指向正二十面体与正十二面体的全部顶点。点一根杆，就能在终点长出同样的球。',
    narration: '把五重、三重、二重三类方向收进同一个球，共 62 个孔。只打开红色十二孔，沿杆生长，会得到正二十面体的十二个顶点；只打开黄色二十孔，则得到正十二面体的二十个顶点。',
    interaction: '左侧开关三类孔。拖动进度条伸缩杆长。点击空闲的杆，在终点放上一颗同样的球。',
  },
  {
    id: 'zometool-node',
    number: '09',
